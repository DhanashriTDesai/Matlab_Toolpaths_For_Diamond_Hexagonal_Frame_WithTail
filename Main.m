...
t=3; theta=60; rho_rel=0.2; % parameters of unit cell
nH=5; nV=4; % no of cells in horizontal and vertical direction 
CellType='BendingDominatedHexagon'; %      StretchDominatedDiamond BendingDominatedHexagon
...
WriteToFile(CellType,NodalPath,nx,ny,E0,E,nH,nV,nExtr,nL,lhD);